...
class PatchEmbedding(nn.Module):
    def __init__(self, in_channels: int = 10, patch_size_x: int = 3, patch_size_y: int = 3, emb_size: int = 90, img_size: int = 9):
        self.patch_size_x = patch_size_x
        self.patch_size_y = patch_size_y
        self.positions_num = (img_size // self.patch_size_x) * (img_size // self.patch_size_y) + 1
        super().__init__()
...
class ClassificationHead(nn.Sequential):
    def __init__(self, emb_size: int = 90, n_classes: int = 5):
        super().__init__(
...
class CIT_NET(nn.Sequential):
    def __init__(self,     
                ...
                img_size: int = 9,
                depth: int = 12,
                n_classes: int = 5,#SEED-V: 5; SEED-IV: 4
                **kwargs):
        super().__init__(
            Conv_Layers(),
